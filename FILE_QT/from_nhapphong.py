...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(Uti.image_path("wireless-charging.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(Uti.image_path("door.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(Uti.image_path("kvkhac.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
