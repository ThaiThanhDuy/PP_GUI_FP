...
"")
    ...
    def retranslateUi(self, Form_them):
        ...
        self.label_themvao.setText(_translate("Form_them", "Nhận dạng camera bị lỗi.\n"
" Vui lòng điều chỉnh hình tròn. "))
        self.btn_error_cam.setText(_translate("Form_them", "Xác nhận"))
