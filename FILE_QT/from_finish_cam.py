...
class Ui_Form_finish_cam(object):
    def setupUi(self, Form_finish_cam):
        Form_finish_cam.setObjectName("Form_finish_cam")
        Form_finish_cam.resize(550, 250)
        Form_finish_cam.setStyleSheet("")
        self.frames = QtWidgets.QFrame(Form_finish_cam)
...
"border-radius: 20px;")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../ROBOT_HD/images/check.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.retranslateUi(Form_finish_cam)
        QtCore.QMetaObject.connectSlotsByName(Form_finish_cam)

    def retranslateUi(self, Form_finish_cam):
        _translate = QtCore.QCoreApplication.translate
        Form_finish_cam.setWindowTitle(_translate("Form_finish_cam", "Form"))
        self.label_themvao.setText(_translate("Form_finish_cam", "Đã đúng vị trí home"))
        self.btn_xacnhan_hoanthanh_cam.setText(_translate("Form_finish_cam", "Xác nhận"))
