...
# Form implementation generated from reading ui file 'from_dang_nd_cam.ui'
#
...
class Ui_Form_dangnhap_cam(object):
...
"border-radius: 20px;")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(Uti.image_path("waiting-room.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon)
        self.pushButton.setIconSize(QtCore.QSize(80, 80))
        self.pushButton.setObjectName("pushButton")
        self.btn_dang_nd_cam = QtWidgets.QPushButton(self.frames)
        self.btn_dang_nd_cam.setGeometry(QtCore.QRect(420, 180, 110, 50))
        self.btn_dang_nd_cam.setMinimumSize(QtCore.QSize(100, 50))
        self.btn_dang_nd_cam.setMaximumSize(QtCore.QSize(150, 50))
        self.btn_dang_nd_cam.setStyleSheet("QPushButton#btn_dang_nd_cam{\n"
"     border-radius: 10px;\n"
...
"}\n"
"")
        self.btn_dang_nd_cam.setIconSize(QtCore.QSize(80, 80))
        self.btn_dang_nd_cam.setObjectName("btn_dang_nd_cam")
    ...
    def retranslateUi(self, Form_them):
        ...
        self.label_themvao.setText(_translate("Form_them", "Di chuyển Robot đến khu vực chờ .\n"
" Sau đó bấm xác nhận, đợi 10s camera sẽ tự tắt"))
        self.btn_dang_nd_cam.setText(_translate("Form_them", "Xác nhận"))
